...
**Tracking the systems and world of Kerpal.**
...
[Devlog](#-development-log) · [System Requirements](#-system-requirements) · [FAQ](#-faq)
...
This repository records pre-alpha development work for Wild Life, a story-driven open-world action RPG for adults. The game is set on the planet Kerpal and follows Max and Maya through exploration, quests, combat, relationships, and mature content. Current work is focused on refining the world, systems, and narrative presentation.

This devlog is for players and developers interested in open-world RPG production, combat systems, narrative design, and adult game development.
...
- 🌍 **Open World** — Explore forests, grasslands, beaches, canyons, deserts, caves, settlements, and ruins.
- ⚔️ **Action Combat** — Use timing, movement, dodges, parries, stamina management, and varied weapons.
- 🧭 **Story and Quests** — Follow connected journeys through main quests, side quests, factions, and hidden histories.
- 👥 **Relationships** — Build trust, pursue romances, and encounter mature character-driven content.
- 📈 **RPG Progression** — Improve attributes, unlock perks, and equip weapons and gear.
...
| **Processor** | AMD Ryzen 5 2600 | AMD Ryzen 5 5600X |
| **RAM** | 8 GB | 16 GB |
| **Graphics** | GeForce GTX 1060 | GeForce RTX 3070 |
| **Storage** | 25 GB available space | 25 GB available space |
| **Additional** | DirectX 11, onboard sound card | DirectX 11, onboard sound card |
